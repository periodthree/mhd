...
<p>myHVACdiscount.com has been established by <a href="http://creggercompany.com">Cregger Company Inc</a> in order to provide HVAC replacement assistance to the citizens of South Carolina as we recover from the massive flooding that has done so much damage to our beautiful state.</p>
...
<p class="clearfix">
    <img class="center-block" src="{{ asset('assets/img/cregger-logo-green-opt.png') }}" alt="Cregger Company">
</p>
...
@section('sidebar')
    ...
    <div class="panel panel-default panel-spaced-top">
        <div class="panel-heading">
            <h2 class="panel-title">Supporting Manufacturers</h2>
        </div>
